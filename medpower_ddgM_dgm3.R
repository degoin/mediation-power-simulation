...
if (cluster==T) {  
  ...
  # Note that the syntax for this is a little funky.  The first argument is a vector of the numbers 1 to 1000, 
  # each of which will be plugged into myfuction as the first argument, each on different cores (computers).
  # The second argument is the function, and then any arguments after that are any other arguments you need
  # to plug into myfunction. 
} 
...
write.csv(results, file=paste0("/home/degoin/Mediation_power/results/mpower_ddgM_dgm3_",n,".csv"))
